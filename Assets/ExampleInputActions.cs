...
//     version 1.14.2
//     from Assets/ExampleInputActions.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/ExampleInputActions.inputactions".
    /// </summary>
    /// <remarks>
    ...
    ""maps"": [
        {
            ""name"": ""Dev"",
            ""id"": ""7e365460-faec-4384-be7f-baf9093bc4e6"",
            ""actions"": [
                {
                    ""name"": ""ToggleConsole"",
                    ""type"": ""Button"",
                    ""id"": ""2645f3ad-eafc-40ba-8ab9-c4065db9b9c2"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""ExecuteCommand"",
                    ""type"": ""Button"",
                    ""id"": ""6ae9567a-d204-4d9c-809f-ff0f578b7c5e"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""dfa61a72-269b-4bd9-b393-9792e25d386a"",
                ...
                {
                    ""name"": """",
                    ""id"": ""2e0ed066-8692-4f05-9a7f-8b0ee9150025"",
                    ""path"": ""<Keyboard>/enter"",
                    ""interactions"": ""Press"",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
            ...
            m_Dev_ExecuteCommand = m_Dev.FindAction("ExecuteCommand", throwIfNotFound: true);
        }

        ~@ExampleInputActions()
        {
            UnityEngine.Debug.Assert(!m_Dev.enabled, "This will cause a leak and performance issues, ExampleInputActions.Dev.Disable() has not been called.");
        }
        ...
        private readonly InputAction m_Dev_ExecuteCommand;
        /// <summary>
        ...
        public struct DevActions
        {
            ...
            /// </summary>
            public DevActions(@ExampleInputActions wrapper) { m_Wrapper = wrapper; }
            /// <summary>
            /// Provides access to the underlying input action "Dev/ToggleConsole".
            /// </summary>
            public InputAction @ToggleConsole => m_Wrapper.m_Dev_ToggleConsole;
            /// <summary>
            /// Provides access to the underlying input action "Dev/ExecuteCommand".
            /// </summary>
            public InputAction @ExecuteCommand => m_Wrapper.m_Dev_ExecuteCommand;
            /// <summary>
